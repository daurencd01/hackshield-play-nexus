      ...
      <div className="px-4 py-4 md:px-8 md:py-6 max-w-7xl mx-auto">
        ...
        >
          ...
          <h3 className="text-white text-base md:text-lg font-orbitron mb-3">
            Распознай 5 фишинговых писем
          </h3>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="text-[#00ff88] font-orbitron text-2xl font-black">3/5</div>
              <div className="text-gray-500 text-[10px] font-mono uppercase">Награда: +200 XP</div>
            </div>
        ...
        <section>
          ...
          <div className="space-y-2.5">
            <ActivityItem
              icon="🎯"
              title="Миссия 'Фишинг 2.0' завершена"
              time="2 часа назад"
              xp={150}
            />
            <ActivityItem
              icon="🏆"
              title="Получен бейдж 'Форензик'"
              time="Вчера"
              xp={50}
            />
            <ActivityItem
              icon="🎮"
              title="Пройдено 3 комнаты в 2D игре"
              time="2 дня назад"
              xp={120}
            />
          </div>
